...
### 🔹 Backend
- **ASP.NET Core** (MVC, Web API, Enterprise Applications)
...
- **Oracle Database**
- Query optimization, indexing, transactional integrity
...
- Developing **banking and financial systems** with strict compliance requirements
- Working with **large legacy systems** and modernizing them incrementally
- Handling **high-risk, high-impact production environments**
- Writing code that is reviewed, audited, and production-hardened
